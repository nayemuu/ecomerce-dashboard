...
import BlackWhiteSubmitButtonWithHFull from '../../../components/reuseable/Buttons/Submit-Buttons/BlackWhiteSubmitButtonWithHFull/BlackWhiteSubmitButtonWithHFull';
                ...
                <div className="-m-1.5 overflow-x-auto">
                  <div className="p-1.5 min-w-full inline-block align-middle">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div className="max-w-60 w-full h-[43px]">
